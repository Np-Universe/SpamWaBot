...
\033[33;1m╔════════════════════════════════════════════════╗
\033[33;1m║\033[36;1m [•] Yotube  : JustNp \033[33;1m ║
\033[33;1m╚════════════════════════════════════════════════╝
\033[36;1m╔═══════════════════════════╗
   \033[36;1m║\033[33;1m WE JUST WANT TO HAVE FUN \033[36;1m ║
\033[36;1m╚═══════════════════════════╝
""")
    except requests.exceptions.ConnectionError:
        sys.exit(f"{W}[{R}!{W}] Error Check Your Network{abu}....{abu}")
    except KeyboardInterrupt:
        sys.exit(f"{W}[{R}!{W}] Exit{abu}...{W}")
...
def put():
    ...
    try:
        ...
        typing("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m PILIHAN Nomor \033[1;33m• \033[0m\033[1;30m]══════════════>")
        typing("\033[37m[\033[31m•\033[37m]\033[32m Contoh nomor\033[37m : \033[37m\033[33m8Xxxxxxx\033[33m")
        mr_am=input(f"\n\033[37m[\033[31m•\033[37m]\033[32m Nomor Target\033[32m \033[37m:\033[37m\033[33m ")
        typing("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m MASUKAN JUMLAH \033[1;33m• \033[0m\033[1;30m]═════════════>")
        ...
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                typing(f"{W}[{G}✓{W}] Sending Spam Call To {Y}{mr_am}")
            else:
                typing(f"{W}[{R}×{W}] Failed Sending Spam Call To {Y}{mr_am}")
            time.sleep(1)
            ...
            gas = sms.text
            if "Succesful" in gas:
                typing(f"{W}[{R}×{W}] Failed Sending Spam Wa To {Y}{mr_am}")
            else:
                typing(f"{W}[{G}✓{W}] Sending Spam Wa To {Y}{mr_am}")
            time.sleep(1)
            ...
            if "ok" in dekor2:
                typing(f"{W}[{G}✓{W}] Sending Spam Sms To {Y}{mr_am}")
            else:
                typing(f"{W}[{R}×{W}] Failed Sending Spam Sms To {Y}{mr_am}")
            time.sleep(1)
            ...
            if "PENDING" in AmmarGamteng:
                ...
                typing(f"{W}[{R}×{W}] Failed Sending Spam Sms To {Y}{mr_am}{W}")
            time.sleep(1)
        ...
        sys.exit(f"{W}[{R}!{W}] Error Check Your Connection{abu}....{abu}")
    except KeyboardInterrupt:
        sys.exit(f"{W}[{R}!{W}] Exit!!{abu}...{W}")
    except ValueError:
        sys.exit(f"{W}[{Y}!{W}] Jangan asal masukin kontol!!!{abu}.....")
